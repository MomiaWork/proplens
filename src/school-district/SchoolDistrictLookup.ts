...
import type { AddressPointStore } from "../address-to-village/AddressPointStore.ts";
import { parseSchoolDistrictText, type BoundaryCarveOut } from "./SchoolDistrictTable.ts";
