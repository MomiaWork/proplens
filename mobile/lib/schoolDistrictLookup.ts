// Mirrors src/school-district/SchoolDistrictLookup.ts — duplicated (and
// ported from node:fs.readFileSync to expo-file-system) because Metro
// doesn't bundle files outside this app's root and RN has no node:fs.
