...
import { FixtureGeocodingClient } from "../geocoding/FixtureGeocodingClient";
import { TransactionStore } from "../transactions/TransactionStore";
import { TransactionEtl } from "../transactions/TransactionEtl";
import { FixtureTransactionDownloader } from "../transactions/FixtureTransactionDownloader";
import { enrichTransactionZones } from "../transactions/enrichTransactionZones";
import type { RawTransactionRecord } from "../transactions/types";
 ...
 * (tools/server.ts) so the two stay in sync.
 *
...
export const elementaryDistrictDataPath = fileURLToPath(
  new URL("../school-district/fixtures/elementary.json", import.meta.url).href,
);
export const juniorHighDistrictDataPath = fileURLToPath(
  new URL("../school-district/fixtures/juniorHigh.json", import.meta.url).href,
);
...
export const zoningDataPath = fileURLToPath(new URL("../zoning/fixtures/sample-zones.geojson", import.meta.url).href);
